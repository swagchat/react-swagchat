...
const getInitialState = (): IPluginState => ({
  ...
  currentMenuIndex: 0,
  roomListItems: {
    [RoomType.ONE_ON_ONE]: new PluginRoomListItemRoomNameWithMessage(),
    [RoomType.PRIVATE_ROOM]: new PluginRoomListItemRoomAndUserNameWithMessage(),
    [RoomType.PUBLIC_ROOM]: new PluginRoomListItemRoomAndUserNameWithMessage(),
    [RoomType.NOTICE_ROOM]: new PluginRoomListItemRoomNameWithMessage(),
  },
