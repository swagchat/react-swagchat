        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (selectContactUserIds.length === 1) {
                    action.room.type = swagchat_sdk_1.RoomType.ONE_ON_ONE;
                }
                else {
                    action.room.type = swagchat_sdk_1.RoomType.PRIVATE_ROOM;
                }
            ...
            case 2:
                ...
                existRoomId = '';
                if (!(action.room.type === swagchat_sdk_1.RoomType.ONE_ON_ONE)) return [3 /*break*/, 3];
                // exist check
            ...
            case 4:
                ...
                _a.label = 5;
            case 5:
                if (!(action.room.type !== swagchat_sdk_1.RoomType.ONE_ON_ONE)) return [3 /*break*/, 7];
            ...
            case 6:
                ...
                return [2 /*return*/];
            case 7:
                if (!(existRoomId === '')) return [3 /*break*/, 9];
            ...
            case 8:
                fetchRoomRes = _a.sent();
                return [3 /*break*/, 11];
            case 9: return [4 /*yield*/, effects_1.call(function (roomId) {
                    return state.client.client.getRoom(roomId);
                }, existRoomId)];
            case 10:
                fetchRoomRes = _a.sent();
                _a.label = 11;
            case 11:
                if (!fetchRoomRes.room) return [3 /*break*/, 20];
                return [4 /*yield*/, effects_1.put(room_1.roomFetchRequestSuccessActionCreator(fetchRoomRes.room))];
            case 12:
                _a.sent();
                return [4 /*yield*/, effects_1.put(message_1.beforeMessagesFetchActionActionCreator(fetchRoomRes.room.messageCount, 20))];
            ...
            case 14:
                fetchMessageRes = _a.sent();
                if (!fetchMessageRes.messages) return [3 /*break*/, 17];
                return [4 /*yield*/, effects_1.put(message_1.messagesFetchRequestSuccessActionCreator(fetchMessageRes.messages))];
            case 15:
                _a.sent();
                return [4 /*yield*/, effects_1.put(user_1.markAsReadRequestActionCreator(fetchRoomRes.room.roomId))];
            case 16:
                ...
                return [3 /*break*/, 19];
            case 17: return [4 /*yield*/, effects_1.put(message_1.messagesFetchRequestFailureActionCreator(fetchMessageRes.error))];
            case 18:
                _a.sent();
                _a.label = 19;
            case 19: return [3 /*break*/, 22];
            case 20: return [4 /*yield*/, effects_1.put(room_1.roomFetchRequestFailureActionCreator(fetchRoomRes.error))];
            case 21:
                _a.sent();
                _a.label = 22;
...
function assetPostAndRoomCreateAndFetchMessages() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                fetchRoomRes = _a.sent();
                if (!fetchRoomRes.room) return [3 /*break*/, 16];
                return [4 /*yield*/, effects_1.put(room_1.roomFetchRequestSuccessActionCreator(fetchRoomRes.room))];
            case 8:
                _a.sent();
                return [4 /*yield*/, effects_1.put(message_1.beforeMessagesFetchActionActionCreator(fetchRoomRes.room.messageCount, 20))];
            ...
            case 10:
                fetchMessageRes = _a.sent();
                if (!fetchMessageRes.messages) return [3 /*break*/, 13];
                return [4 /*yield*/, effects_1.put(message_1.messagesFetchRequestSuccessActionCreator(fetchMessageRes.messages))];
            case 11:
                _a.sent();
                return [4 /*yield*/, effects_1.put(user_1.markAsReadRequestActionCreator(fetchRoomRes.room.roomId))];
            case 12:
                ...
                return [3 /*break*/, 15];
            case 13: return [4 /*yield*/, effects_1.put(message_1.messagesFetchRequestFailureActionCreator(fetchMessageRes.error))];
            case 14:
                _a.sent();
                _a.label = 15;
            case 15: return [3 /*break*/, 18];
            case 16: return [4 /*yield*/, effects_1.put(room_1.roomFetchRequestFailureActionCreator(fetchRoomRes.error))];
            case 17:
                _a.sent();
                _a.label = 18;
            case 18: return [4 /*yield*/, effects_1.put(room_1.roomUpdateClearActionCreator())];
            case 19:
                _a.sent();
                return [2 /*return*/];
        }
