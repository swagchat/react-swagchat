    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                existRoomId = '';
                if (action.room.type === swagchat_sdk_1.RoomType.ONE_ON_ONE) {
                    // exist check
                ...
                if (!(existRoomId === '')) return [3 /*break*/, 3];
            ...
            case 2:
                fetchRoomRes = _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, effects_1.call(function (roomId) {
                    return state.client.client.getRoom(roomId);
                }, existRoomId)];
            case 4:
                fetchRoomRes = _a.sent();
                _a.label = 5;
            case 5:
                if (!fetchRoomRes.room) return [3 /*break*/, 14];
                return [4 /*yield*/, effects_1.put(room_1.roomFetchRequestSuccessActionCreator(fetchRoomRes.room))];
            case 6:
                _a.sent();
                return [4 /*yield*/, effects_1.put(message_1.beforeMessagesFetchActionActionCreator(fetchRoomRes.room.messageCount, 20))];
            ...
            case 12:
                ...
                _a.label = 13;
            case 13: return [3 /*break*/, 16];
            case 14: return [4 /*yield*/, effects_1.put(room_1.roomFetchRequestFailureActionCreator(fetchRoomRes.error))];
            case 15:
                _a.sent();
                _a.label = 16;
