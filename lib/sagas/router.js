...
function locationChange() {
    var state, pathname, roomListPathRegExp, messagePathRegExp, roomSettingPathRegExp, selectContactPathRegExp, res, roomId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!roomListPathRegExp) return [3 /*break*/, 4];
                return [4 /*yield*/, effects_1.put(message_1.clearMessagesActionCreator())];
            case 2:
                _a.sent();
                return [4 /*yield*/, effects_1.put(user_2.userAuthRequestActionCreator())];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
                if (!(messagePathRegExp || roomSettingPathRegExp)) return [3 /*break*/, 16];
            ...
            case 11:
                if (!roomSettingPathRegExp) return [3 /*break*/, 13];
            ...
            case 14: return [4 /*yield*/, effects_1.put(user_1.userFetchRequestFailureActionCreator(res.error))];
            case 15:
                _a.sent();
                _a.label = 16;
            case 16:
                if (!selectContactPathRegExp) return [3 /*break*/, 18];
