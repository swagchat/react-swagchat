...
exports.Exit = function (props) { return (React.createElement("svg", { viewBox: "0 0 24 24", className: props.className ? props.className : 'icon', style: props.style ? props.style : {} },
