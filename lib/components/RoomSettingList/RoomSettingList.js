...
var RoomSettingList = (function (_super) {
    ...
    RoomSettingList.prototype.render = function () {
        var _this = this;
        var _a = this.props, userState = _a.userState, roomState = _a.roomState, styleState = _a.styleState, updateStyle = _a.updateStyle, roomUpdateName = _a.roomUpdateName, roomUpdatePicture = _a.roomUpdatePicture;
                ...
                if (roomState.room.type === swagchat_sdk_1.RoomType.ONE_ON_ONE) {
                    ...
                    if (users && users.length > 0 && users[0].isCanBlock) {
                        ...
                        return (React.createElement("div", { className: "room-setting-list-root" },
                            React.createElement(_1.IconListItem, { title: title, leftIcon: React.createElement(_1.Button, { icon: React.createElement(_1.Block, null) }), onClick: _this.modalViewTap.bind(_this, 'block', true) }),
                            React.createElement(_1.ModalDialog, { modalKey: "block", description: modalDescription, actions: blockActions, styleState: styleState, updateStyle: updateStyle })));
                    }
                    return null;
                }
                else {
                    if (roomState.room.isCanLeft) {
                        ...
                        return (React.createElement("div", null,
                            React.createElement(_1.IconListItem, { title: "グループ情報編集", leftIcon: React.createElement(_1.Button, { icon: React.createElement(_1.Edit, null) }), onClick: _this.modalViewTap.bind(_this, 'roomEdit', true) }),
                            React.createElement(_1.ModalView, { title: "グループ情報編集", component: React.createElement(components_1.RoomEdit, { roomName: roomState.room.name, roomPictureUrl: roomState.room.pictureUrl, roomUpdateName: roomUpdateName, roomUpdatePicture: roomUpdatePicture }), modalKey: "roomEdit", styleState: styleState, updateStyle: updateStyle, onOkClick: _this.onRoomEditOkClick.bind(_this) }),
                            React.createElement(_1.IconListItem, { title: "退会する", leftIcon: React.createElement(_1.Button, { icon: React.createElement(_1.Exit, null) }), onClick: _this.modalViewTap.bind(_this, 'left', true) }),
                            React.createElement(_1.ModalDialog, { modalKey: "left", description: "退会しますか？", actions: leftActions, styleState: styleState, updateStyle: updateStyle })));
                    }
                    return null;
                }
            })())));
