                ...
                if (roomState.room.type === swagchat_sdk_1.RoomType.ONE_ON_ONE) {
                    ...
                    if (roomState.room.isCanLeft) {
                        ...
                        return (React.createElement("div", null,
                            ...
                            React.createElement(_1.IconListItem, { title: "退出する", leftIcon: React.createElement(_1.Button, { icon: React.createElement(_1.Exit, null) }), onClick: _this.modalViewTap.bind(_this, 'left', true) }),
                            React.createElement(_1.ModalDialog, { modalKey: "left", description: "退出しますか？", actions: leftActions, styleState: styleState, updateStyle: updateStyle })));
                    }
                    return null;
                }
            })())));
