            ...
            React.createElement("div", { className: "modal-view-content-wrap", onClick: this.onWrapTap },
                React.createElement("div", { className: "modal-view-root" },
                    React.createElement("div", { className: "modal-view-header" },
                        React.createElement(_1.Button, { icon: React.createElement(_1.Close, { className: "modal-view-icon" }), onClick: this.onCloseTap.bind(this) }),
                        React.createElement("div", { className: "modal-view-title" }, title),
                        React.createElement(_1.Button, { icon: React.createElement(_1.Done, { className: "modal-view-icon" }), onClick: this.props.onOkClick })),
                    component)))) : null));
    };
    return ModalView;
}(React.Component));
