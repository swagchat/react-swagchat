...
var MessageMenu = (function (_super) {
    __extends(MessageMenu, _super);
    function MessageMenu() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MessageMenu.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "message-menu-root" }, (function () {
            ...
            if (_this.props.availableMessageTypes && _this.props.availableMessageTypes.length > 0) {
                for (var i = 0; i < _this.props.availableMessageTypes.length; i++) {
                    ...
                    for (var j = 0; j < _this.props.pluginState.customMessages.length; j++) {
                        ...
                        if (plugin.name === availableMessageType) {
                            interactions.push(React.createElement(_this.props.pluginState.customMessages[_this.props.currentMenuIndex].menu, {
                ...
                for (var i = 0; i < _this.props.pluginState.messages.length; i++) {
                    interactions.push(React.createElement(_this.props.pluginState.messages[i].menu, {
                        key: 'plugin-message-interaction-' + i,
                        userState: _this.props.userState,
                        roomState: _this.props.roomState,
                        ownMenuIndex: i,
