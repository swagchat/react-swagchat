...
var RoomList = (function (_super) {
    ...
    RoomList.prototype.render = function () {
        var _this = this;
        var _a = this.props, myUserId = _a.myUserId, roomListItems = _a.roomListItems, title = _a.title, hasTopBar = _a.hasTopBar, hasTabBar = _a.hasTabBar, noRoomListText = _a.noRoomListText, noRoomListImage = _a.noRoomListImage, userRooms = _a.userRooms, noAvatarImages = _a.noAvatarImages;
            ...
            (function () {
                if (userRooms && userRooms.length > 0) {
                    ...
                    for (var i = 0; i < userRooms.length; i++) {
                        roomItems.push(React.createElement(RoomItem_1.RoomItem, { key: i, roomListItems: roomListItems, myUserId: myUserId, userRoom: userRooms[i], noAvatarImages: noAvatarImages, onClick: _this.onClick.bind(_this) }));
                    }
                    return roomItems;
                }
                else {
