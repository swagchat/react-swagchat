...
var RoomItem = (function (_super) {
    ...
    RoomItem.prototype.render = function () {
        var _a = this.props, myUserId = _a.myUserId, roomListItems = _a.roomListItems, userRoom = _a.userRoom, onClick = _a.onClick, customRoomListItems = _a.customRoomListItems, noAvatarImages = _a.noAvatarImages;
