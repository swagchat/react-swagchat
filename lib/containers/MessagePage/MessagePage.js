...
var MessagePage = (function (_super) {
    ...
    MessagePage.prototype.render = function () {
        var _a = this.props, roomState = _a.roomState, settingState = _a.settingState, userState = _a.userState, pluginState = _a.pluginState, history = _a.history, messageState = _a.messageState, styleState = _a.styleState, createMessage = _a.createMessage, sendMessages = _a.sendMessages, updateMenuIndex = _a.updateMenuIndex, updateStyle = _a.updateStyle, assetPostAndSendMessage = _a.assetPostAndSendMessage, markAsRead = _a.markAsRead, updateRoom = _a.updateRoom;
        ...
        return (React.createElement("div", null,
            React.createElement(_1.TopBar, { title: name, leftButton: React.createElement(_1.Button, { icon: React.createElement(_1.Back, null), onClick: history.goBack }), rightButton: React.createElement(_1.Avatar, { onClick: this.onRoomSetting.bind(this), src: pictureUrl ? pictureUrl : settingState.noAvatarImages[0], width: 30, height: 30, margin: 9 }) }),
            React.createElement(_1.MessageBody, { pluginState: pluginState, userState: userState, roomState: roomState, messageState: messageState, styleState: styleState, createMessage: createMessage, sendMessages: sendMessages, updateMenuIndex: updateMenuIndex, updateStyle: updateStyle, settingState: settingState, assetPostAndSendMessage: assetPostAndSendMessage, markAsRead: markAsRead, updateRoom: updateRoom })));
    };
    return MessagePage;
}(React.Component));
