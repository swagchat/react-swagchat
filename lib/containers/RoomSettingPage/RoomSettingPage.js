...
var RoomSettingPage = (function (_super) {
    ...
    RoomSettingPage.prototype.render = function () {
        var _a = this.props, settingState = _a.settingState, roomState = _a.roomState, userState = _a.userState, history = _a.history, styleState = _a.styleState, updateStyle = _a.updateStyle, userBlockFetch = _a.userBlockFetch, userUnBlockFetch = _a.userUnBlockFetch, roomUserRemoveFetch = _a.roomUserRemoveFetch;
        ...
        return (React.createElement("div", { className: "room-setting-page-root" },
            React.createElement(_1.TopBar, { title: settingState.roomSettingTitle, leftButton: React.createElement(_1.Button, { icon: React.createElement(_1.Back, null), onClick: history.goBack }) }),
            React.createElement(_1.SimpleListItem, { name: name, pictureUrl: pictureUrl ? pictureUrl : settingState.noAvatarImages[0], width: 80, height: 80 }),
            React.createElement(_1.RoomSettingList, { desableMarginTop: false, userState: userState, roomState: roomState, styleState: styleState, displayNoDataText: "No contacts.", updateStyle: updateStyle, onItemTap: this.onItemTap.bind(this), userBlockFetch: userBlockFetch, userUnBlockFetch: userUnBlockFetch, roomUserRemoveFetch: roomUserRemoveFetch }),
            (function () {
                if (roomState.room.type !== swagchat_sdk_1.RoomType.ONE_ON_ONE && roomState.room.isShowUsers && roomState.room.type !== swagchat_sdk_1.RoomType.NOTICE_ROOM) {
                    return (React.createElement("div", { className: "layout-box-1" },
                        React.createElement(_1.SubTitleBar, { title: settingState.roomMembersTitle, isDisplayBorder: false }),
                        (function () {
                            var users = new Array;
