...
var RoomSettingPage = (function (_super) {
    ...
    RoomSettingPage.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "room-setting-page-root" },
            ...
            React.createElement(_1.RoomSettingList, { desableMarginTop: false, userState: userState, roomState: roomState, styleState: styleState, displayNoDataText: "No contacts.", updateStyle: updateStyle, onItemTap: this.onItemTap.bind(this), userBlockFetch: userBlockFetch, userUnBlockFetch: userUnBlockFetch, roomUserRemoveFetch: roomUserRemoveFetch, roomUpdateName: roomUpdateName, roomUpdatePicture: roomUpdatePicture, assetPostAndRoomUpdate: assetPostAndRoomUpdate }),
            (function () {
