...
var room_2 = require("../../actions/room");
...
var SelectContactPage = (function (_super) {
    ...
    SelectContactPage.prototype.render = function () {
        var _a = this.props, selectContactTitle = _a.selectContactTitle, userState = _a.userState, roomState = _a.roomState, styleState = _a.styleState, settingState = _a.settingState, noContactListText = _a.noContactListText, noContactListImage = _a.noContactListImage, updateStyle = _a.updateStyle, roomUpdateName = _a.roomUpdateName, roomUpdatePicture = _a.roomUpdatePicture;
        return (React.createElement("div", null,
            React.createElement(_1.TopBar, { title: selectContactTitle, leftButton: React.createElement(_1.Button, { icon: React.createElement(_1.Close, null), onClick: this.onCloseButton.bind(this) }), rightButton: React.createElement(_1.Button, { icon: React.createElement(_1.Done, null), onClick: this.onOkButton.bind(this) }) }),
            ...
            React.createElement(_1.ModalView, { title: "グループ情報登録", component: React.createElement(_1.RoomEdit, { roomName: roomState.updateName, roomPictureUrl: utils_1.randomAvatarUrl(settingState.noAvatarImages), roomUpdateName: roomUpdateName, roomUpdatePicture: roomUpdatePicture }), modalKey: "roomCreate", styleState: styleState, updateStyle: updateStyle, onOkClick: this.onRoomCreateOkClick.bind(this) })));
    };
