...
var RoomListPage = (function (_super) {
    ...
    RoomListPage.prototype.render = function () {
        var _a = this.props, roomListTitle = _a.roomListTitle, userId = _a.userId, userRooms = _a.userRooms, roomListItems = _a.roomListItems, customRoomListItems = _a.customRoomListItems, roomListTabbar = _a.roomListTabbar, noRoomListText = _a.noRoomListText, noRoomListImage = _a.noRoomListImage, noAvatarImages = _a.noAvatarImages;
        return (React.createElement("div", null,
            ...
            React.createElement(components_1.RoomList, { myUserId: userId, userRooms: userRooms, roomListItems: roomListItems, customRoomListItems: customRoomListItems, hasTopBar: true, hasTabBar: roomListTabbar ? true : false, noRoomListText: noRoomListText, noRoomListImage: noRoomListImage, noAvatarImages: noAvatarImages, onClick: this.onItemTap.bind(this) }),
