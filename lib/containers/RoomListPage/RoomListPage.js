...
var RoomListPage = (function (_super) {
    ...
    RoomListPage.prototype.onItemTap = function (room) {
        if (this.props.history) {
            stores_1.store.dispatch(react_router_redux_1.push('/messages/' + room.roomId));
        }
    };
    RoomListPage.prototype.onCreateRoomButton = function () {
        if (this.props.history) {
            stores_1.store.dispatch(react_router_redux_1.push('/selectContact'));
        }
    };
    RoomListPage.prototype.render = function () {
        var _a = this.props, roomListTitle = _a.roomListTitle, userId = _a.userId, userRooms = _a.userRooms, roomListItems = _a.roomListItems, roomListTabbar = _a.roomListTabbar, noRoomListText = _a.noRoomListText, noRoomListImage = _a.noRoomListImage;
        return (React.createElement("div", null,
            React.createElement(_1.TopBar, { title: roomListTitle, rightButton: React.createElement(_1.Button, { icon: React.createElement(_1.AddCircle, null), onClick: this.onCreateRoomButton.bind(this) }) }),
            React.createElement(_1.RoomList, { myUserId: userId, userRooms: userRooms, roomListItems: roomListItems, hasTopBar: true, hasTabBar: roomListTabbar ? true : false, noRoomListText: noRoomListText, noRoomListImage: noRoomListImage, onClick: this.onItemTap.bind(this) }),
