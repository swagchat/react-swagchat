...
function message(state, action) {
    ...
    switch (action.type) {
        ...
        case message_1.CREATE_MESSAGE:
            ...
            var message_2 = swagchat_sdk_1.createMessage(rootState.room.room.roomId, rootState.user.user.userId, createMessageAction.messageType, createMessageAction.payload);
        ...
        case message_1.MESSAGES_SEND_REQUEST_SUCCESS:
            ...
            messagesSendAction.messages.forEach(function (message) {
