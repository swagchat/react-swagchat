...
exports.renderMessagePage = function (params) {
    ReactDom.render(React.createElement(RouteMessagePage, { noMessageText: params.noMessageText, noMessageImage: params.noMessageImage, inputMessagePlaceholderText: params.inputMessagePlaceholderText, renderDomId: params.renderDomId, apiKey: params.apiKey, apiEndpoint: params.apiEndpoint, realtimeEndpoint: params.realtimeEndpoint, userId: params.userId, userAccessToken: params.userAccessToken, messageRoutePath: params.messageRoutePath }), document.getElementById(params.renderDomId));
};
