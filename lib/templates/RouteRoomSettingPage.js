...
var RouteRoomSettingPage = (function (_super) {
    ...
    function RouteRoomSettingPage(props, context) {
        ...
        stores_1.store.dispatch(combined_1.combinedUserAndRoomFetchRequestActionCreator(apiKey, props.route ? props.route.apiEndpoint : props.apiEndpoint, props.route ? props.route.realtimeEndpoint : props.realtimeEndpoint, userId, userAccessToken, props.params.roomId));
        return _this;
    }
