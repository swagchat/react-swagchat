...
exports.renderRoomSetting = function (params) {
    ReactDom.render(React.createElement(RouteRoomSettingPage, { roomSettingTitle: params.roomSettingTitle, roomMembersTitle: params.roomMembersTitle, renderDomId: params.renderDomId, apiKey: params.apiKey, apiEndpoint: params.apiEndpoint, realtimeEndpoint: params.realtimeEndpoint, userId: params.userId, userAccessToken: params.userAccessToken, roomSettingRoutePath: params.roomSettingRoutePath }), document.getElementById(params.renderDomId));
};
