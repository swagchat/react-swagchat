...
var plugin_1 = require("swagchat-sdk/src/actions/plugin");
...
var TemplateMessenger = (function (_super) {
    ...
    function TemplateMessenger(props, context) {
        ...
        var scRoomListItemPlugins = _this.props.route && _this.props.route.scRoomListItemPlugins ? _this.props.route.scRoomListItemPlugins : {
            1: new roomListItem_1.PluginRoomListItemRoomNameWithMessage(),
            2: new roomListItem_1.PluginRoomListItemRoomAndUserNameWithMessage(),
        };
        stores_1.store.dispatch(plugin_1.setPluginRoomListItemActionCreator(scRoomListItemPlugins));
