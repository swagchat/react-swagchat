...
var TextInteraction = (function (_super) {
    ...
    TextInteraction.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "text-interaction-root" },
            ...
            React.createElement(components_1.Button, { className: "text-interaction-send-button", icon: React.createElement(components_1.Send, { className: "text-interaction-send-icon", style: this.sendIconStyle }), onClick: this.onClick.bind(this) })));
    };
